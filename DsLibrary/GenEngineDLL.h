#ifndef __GEN_ENGINE_DLL_H__
#define __GEN_ENGINE_DLL_H__
...
typedef int (*GenericEngineLooper)(ListItr _begin, ListItr _end, PredicateFunction _predicate, ListActionFunction _action, void* _context1,  void* _context2);
/** 
